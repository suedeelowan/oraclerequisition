                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header" style="width:100%">
                                <h5 class="mb-0">Liste des requisitions en attente d'audit </h5>
                                    ...
                                    <table id="example" class="table table-striped table-bordered second" style="width:100%" data-show-columns="true"   data-cookie-id-table="saveId"  cellspacing="0" data-toggle="table" data-pagination="true" data-search="true" data-show-pagination-switch="false" data-show-refresh="false" data-key-events="true" data-show-toggle="true" data-resizable="false" data-cookie="true"    data-show-export="true" data-click-to-select="false" data-toolbar="#toolbar">
                                       ...
                                       <?php foreach ($all as $index => $one): ?>
                                            <tr style="line-height: 12px ;">
                                                ...
                                                <td style="height: 10px;"><FONT size="1"color="#000000"><?php echo $one['agent_audit']; ?></FONT></td>
                                                <td style="height: 10px;"><FONT size="1" color="#000000"><?php echo $one['type_visite']; ?></FONT></td>
                                                <td style="height: 10px;"><FONT size="1" color="#000000"><?php  $interval = date_diff(date_create($one['date_envoi_reev']), date_create(date('Y-m-d',time())));
                                                ...
                                                <td style="height: 10px;">
                                                    ...
                                                    <span style="font-size:13px; white-space:nowrap;">
                                                        ...
                                                        if(verif_transmis_audit($one['num_tc'])=="1"){ 
                                                            ?>
                                                            <a href="#" class="label label-success " title="Dossier transmis pour validation"   style="background:#b8ecb8;  border-radius:5px;"><i class="fa fa-lock" ></i></a>
                                                        <?php
                                                        }
                                                        elseif( ($one['onglet']=="1"  &&  verifsoumiaudit($one['num_tc'])=="1" && $_SESSION['PROFIL_USER']==9) OR ($_SESSION['PROFIL_USER']==5 || $_SESSION['PROFIL']==2 || $_SESSION['PROFIL_USER']=='2' ) ) { ?>
                                                         <a href="rap_reeval_audit?code=<?php echo md5(time()); ?>&ident=<?php echo $one['num_tc']; ?>&code=<?php echo sha1($one['num_tc']); ?>#" class="label label-success " title="Auditer"   style="background:green;  border-radius:5px;"><i class="fa fa-list" ></i></a>
                                                         <?php } else {  ?>
                                                        ...
                                                        if($_SESSION['PROFIL_USER']==5 || $_SESSION['PROFIL']==2 || $_SESSION['PROFIL_USER']=='2'){
                                                            ?>
                                                            ...
                                                            <div class="modal-body" style="background-color:#cfeeda ;" >     
                                                                <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 mb-5">        
                                                                    ...
                                                                    <div class="simple-card" style="width:1150px; height:1320px; margin-left:0px;">
                                                                        <?php include('include/recotation_audit.php') ; ?>
