                                                        ...
                                                        <table id="table1"  class="table table-striped table-bordered second paginated" style="width:100%;  font-size: 10px;" data-show-columns="true"   data-cookie-id-table="saveId"  cellspacing="0" data-toggle="table" data-pagination="true" data-search="true" data-show-pagination-switch="false" data-show-refresh="false" data-key-events="true" data-show-toggle="true" data-resizable="false" data-cookie="true"    data-show-export="true" data-click-to-select="false" data-toolbar="#toolbar">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr style="background-color:#fff;">
                                                                    <td  style="width: 100%;"><?php echo $i.' - &nbsp;'; echo $tcinfo['LIBELLE_COM'] ; ?></td>
                                                                    ...
                                                                    <td style="background-color: #e2eae5; "><input type="text" name="codesh<?php echo $tcinfo['ADD_CODE_SH'] ; ?>" value="<?php echo $tcinfo['ADD_CODE_SH'] ; ?>"style="width: 80px;" id="codesh<?php echo $i;?>"/>
                                                                    ...
                                                                    <td style="background-color: #e2eae5; "><input type="text" name="origine<?php echo $tcinfo['ADD_ORIGINE'] ; ?>" value="<?php echo $tcinfo['ADD_ORIGINE'] ; ?>"style="width: 40px;" id="origine<?php echo $i;?>"/></td>
                                                                    <td style="background-color: #e2eae5; "><input type="text" name="quantite<?php echo $tcinfo['ADD_QUANTITE'] ; ?>" value="<?php echo $tcinfo['ADD_QUANTITE'] ; ?>"style="width: 50px;" id="quantite<?php echo $i;?>"/><input type="hidden" id="qte<?php echo $i;?>"  value="<?php echo $tcinfo['ADD_QUANTITE'] ; ?>" oninput="calculer()" /></td>
                                                                    
                                                                    <td style="background-color: #e2eae5; "><input type="text" name="unite<?php echo $tcinfo['ADD_UNITE'] ; ?>" value="<?php echo $tcinfo['ADD_UNITE'] ; ?>"style="width: 40px;" id="unite<?php echo $i;?>"/></td>
                                                    ...
                                                    <table id="table2" class="table table-striped table-bordered second" style="width:100%; font-size:10px;" data-show-columns="true"   data-cookie-id-table="saveId"  cellspacing="0" data-toggle="table" data-pagination="true" data-search="true" data-show-pagination-switch="false" data-show-refresh="false" data-key-events="true" data-show-toggle="true" data-resizable="false" data-cookie="true"    data-show-export="true" data-click-to-select="false" data-toolbar="#toolbar">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr style="background-color:#fff;">
                                                                ...
                                                                <td>
                                                                    <input type="hidden" name="ok[]" value="<?php echo $tcinfo['ID_ART'];?>"/>
                                                                    <input type="text" name="sh<?php echo $tcinfo['ID_ART'];?>" value="<?php echo $tcinfo['ADD_CODE_SH'] ; ?>" style="width: 55px;" />
                                                                    <input type="hidden" name="numtc<?php echo $tcinfo['ID_ART'];?>" value="<?php echo $tc_trouve['num_tc']; ?>" style="width: 55px;" />
                                                                </td>
                                                                <td><input type="text" name="origine<?php echo $tcinfo['ID_ART'];?>" value="<?php echo $tcinfo['ADD_ORIGINE'] ; ?>" style="width: 55px;;" /></td>
                                                                <td><input type="text" name="quantite<?php echo $tcinfo['ID_ART'];?>" value="<?php echo $tcinfo['ADD_QUANTITE'] ; ?>" style="width: 35px;;"/></td>
                                                                <td><input type="text" name="unite<?php echo $tcinfo['ID_ART'];?>" value="<?php echo $tcinfo['ADD_UNITE'] ; ?>" style="width: 35px;;"/></td>
                                                                <td><input type="text" name="unite<?php echo $tcinfo['ID_ART'];?>" value="<?php echo $tcinfo['ADD_UNITE'] ; ?>" style="width: 35px;;"/></td>
                                                        ...
                                                        <table  class="test table table-striped table-bordered second paginated1" style="width:100%;  font-size: 10px;" data-show-columns="true"   data-cookie-id-table="saveId"  cellspacing="0" data-toggle="table" data-pagination="true" data-search="true" data-show-pagination-switch="false" data-show-refresh="false" data-key-events="true" data-show-toggle="true" data-resizable="false" data-cookie="true"    data-show-export="true" data-click-to-select="false" data-toolbar="#toolbar">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td> <input type='text' name='trcodesh<?php echo $larticle['ID_ART_TR'];?>' value='<?php echo $larticle['TR_CODE_SH'];?>'style="width:85px;"  />
                                                                            
                                                                        </td>
                                                                        <td><input type='text' name='trorigine<?php echo $larticle['ID_ART_TR'];?>' value='<?php echo $larticle['TR_ORIGINE'];?>'style="width: 40px;" />
                                                                            
                                                                        </td>
                                                                        <td> <input type='text' name='trquantite<?php echo $larticle['ID_ART_TR'];?>' value='<?php echo $larticle['TR_QUANTITE'];?>'style="width:45px;"/> <input type="hidden" id="newqte<?php echo $i;?>"  value="<?php echo $larticle['TR_QUANTITE'] ; ?>" oninput="calculerarticle_new()"  />
                                                                        
                                                                        </td>
                                                                        <td><input type='text' name='unitetrouv<?php echo $larticle['ID_ART_TR'];?>' value='<?php echo $larticle['TR_UNITE'];?>'style="width: 40px;" />
                                                                        ...
                                                                        <td style="background-color: #a9c2b2;"> 
                                                                            <input type='text' name='aj_fobtotal<?php echo $larticle['ID_ART_TR'];?>' value='<?php echo $larticle['TR_FOB_TOTAL'];?>' id="newresultat<?php echo $i ; ?>" style="width:80px;" readonly />
                                                                        </td>
                                                                        <td style="background-color: #a9c2b2;"> 
