...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper"  >
            <div class="container-fluid  dashboard-content" style="width: 1220px; margin-left:250px;" >
                <!-- ============================================================== -->
                <!-- pageheader -->
                <!-- ============================================================== -->
                                       ...
                                       <?php foreach ($all as $index => $one): ?>
                                            <tr style="line-height: 12px ;">
                                                ...
                                                <?php    
                                                         ...
                                                         if($one['onglet']==9){$statut="En attente de validation";}
                                                ...
                                                <td style="height: 10px;">
                                                        ...
                                                        <?php 
                                                        if($one['onglet']=="9" && veriftransmission($one['num_tc']) ) {  ?>
                                                            <a href="rap_inspection_update?serach=<?php echo $one['num_tc']; ?>" class="label label-success " title="Fiche inspection"  style="background:red;  border-radius:5px;"><i class="fa fa-list" ></i></a>

                                                       <?php
                                                        }
                                                        
                                                        elseif($one['onglet']=="9") { ?>
                                                         <a href="rap_inspection_update?serach=<?php echo $one['num_tc']; ?>" class="label label-success " title="Fiche inspection"  style="background:green;  border-radius:5px;"><i class="fa fa-list" ></i></a>
                                                         <?php } else {} ?>
