                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <table id="table1"  class="table table-striped table-bordered second paginated1" style="width:100%" data-show-columns="true"   data-cookie-id-table="saveId"  cellspacing="0" data-toggle="table" data-pagination="true" data-search="true" data-show-pagination-switch="false" data-show-refresh="false" data-key-events="true" data-show-toggle="true" data-resizable="false" data-cookie="true"    data-show-export="true" data-click-to-select="false" data-toolbar="#toolbar">
                                                <thead style="height:20px; height:10px;">
                                                    ...
                                                    <tr style="background-color:#cdcdcd; font-size: 12px;; padding: 2px; margin: 1px; line-height: 1;">
                                                        <td style="width:105px;">Article</td>
                                                        <td>Code SH</td>
                                                        <td>Origine</td>
                                                        <td>Quantite</td>
                                                        <td>Unite</td>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr style="background-color:#fff;">
                                                        <td style=""><?php echo $tcinfo['LIBELLE_COM'] ; ?></td>
                                                        ...
                                                        <td style="background-color: #e2eae5; "><?php echo $tcinfo['ADD_QUANTITE'] ; ?></td>
                                                        
                                                        <td style="background-color: #e2eae5; "><?php echo $tcinfo['ADD_UNITE'] ; ?></td>
                                                        <td style="background-color: #a9c2b2;"><input type="text" name="fobunit<?php echo $tcinfo['ID_ART'];?>" value="<?php echo $tcinfo['ADD_FOB_UNI'] ; ?>" style="width: 100px;;" /></td>
                                                        <td style="background-color: #a9c2b2;"><input type="text" name="fobtotal<?php echo $tcinfo['ID_ART'];?>" value="<?php echo $tcinfo['ADD_FOB_TOTAL'] ; ?>" style="width: 105px;;" /></td>
                                                        <td style="background-color: #a9c2b2;"><input type="text" name="dc<?php echo $tcinfo['ID_ART'];?>" value="<?php echo $tcinfo['DC_PREVISIONNEL'] ; ?>" style="width: 105px;;" /></td>
                                        ...
                                        <div>
                                            <table id="latable" class="test table table-striped table-bordered second paginated" style="width:100%" data-show-columns="true"   data-cookie-id-table="saveId"  cellspacing="0" data-toggle="table" data-pagination="true" data-search="true" data-show-pagination-switch="false" data-show-refresh="false" data-key-events="true" data-show-toggle="true" data-resizable="false" data-cookie="true"    data-show-export="true" data-click-to-select="false" data-toolbar="#toolbar">
                                                    <thead style="height:20px; height:10px;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> <?php echo $larticle['TR_QUANTITE'];?>
