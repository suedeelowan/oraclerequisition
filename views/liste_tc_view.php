                            ...
                            <div class="card-body" style="width:100%">
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped table-bordered second" style="width:100%" data-show-columns="true"   data-cookie-id-table="saveId"  cellspacing="0" data-toggle="table" data-pagination="true" data-search="true" data-show-pagination-switch="false" data-show-refresh="false" data-key-events="true" data-show-toggle="true" data-resizable="false" data-cookie="true"    data-show-export="true" data-click-to-select="false" data-toolbar="#toolbar">
                                       ...
                                       <?php 
                                            if(isset($_GET['traitement']) && $_GET['search']=!""){

                                               //  echo '@@'.$_GET["traitement"];
                                                 $all=getTC($_GET['traitement']); 
                                            }
                                            ...
                                            <tr style="line-height: 12px ;">
                                                ...
                                                <?php    
                                                         ...
                                                         if($one['onglet']==9 && verifretour($one['num_tc'])>0){ $statut="Info Complementaire";}
                                                ...
                                                <td style="height: 10px;">
                                                        ...
                                                        $Leretour='';
                                                         ...
                                                         if($one['onglet']==9){$action="";  /*$action="Enr. visite"; */}
                                                ...
                                                if( ($_SESSION['PROFIL']==1 || $_SESSION['PROFIL_USER']==5) && $one['onglet']=="9" && verifsoumis($one['num_tc'])!='0' && veriftransmission($one['num_tc'])!='0' ){
                                                    ...
                                                    <span style="font-size:13px; white-space:nowrap;">
                                                         ...
                                                         <!-- <a href="#" data-toggle="modal" data-target="#<?php echo $one['id_Tc']; ?>" class="label label-success " style="background:#a1c1e7 ; color:#000;">Voir</a> -->

                                                         <?php if(($_SESSION['PROFIL']==1 || $_SESSION['PROFIL']==5) && $one['onglet']==""){ ?>

                                                         <a href="#" class="label label-success " data-toggle="modal" data-target="#<?php echo $one['id_Tc']; ?>mod" style="background:#a1c1e7 ; color:#000;"><?php echo $action; ?></a>
                                                         <?php } 

                                                        //if(($_SESSION['PROFIL']==1 || $_SESSION['PROFIL']==5) && $one['onglet']!="" && $one['onglet']!="9"  ){
                                                             ?>
                                                        <!-- <a href="#" class="label label-success " data-toggle="modal" data-target="#<?php echo $one['id_Tc']; ?>mod1" style="background:#a1c1e7 ; color:#000;">Modif.Visite</a> -->
                                                        <?php //} 


                                                         if(($_SESSION['PROFIL']==2 || $_SESSION['PROFIL']==5) && $one['onglet']=="1"){ ?>
                                                         <a href="#" class="label label-success " data-toggle="modal" data-target="#<?php echo $one['id_Tc']; ?>mod" style="background:#a1c1e7 ; color:#000;"><?php echo $action; ?></a>
                                                         <?php } ?>

                                                         <?php if(($_SESSION['PROFIL']==2 || $_SESSION['PROFIL']==5) && $one['onglet']=="1" && $one['onglet']!="9"){ ?>
                                                         <a href="#" class="label label-success " data-toggle="modal" data-target="#<?php echo $one['id_Tc']; ?>mod1" style="background:#a1c1e7 ; color:#000;">Modif.Evaluation</a>
                                                         <?php } ?>

                                                         <?php if(($_SESSION['PROFIL']==3 || $_SESSION['PROFIL']==5) && $one['onglet']=="2"){ ?> 
                                                         <a href="#" class="label label-success " data-toggle="modal" data-target="#<?php echo $one['id_Tc']; ?>mod" style="background:#a1c1e7 ; color:#000;"><?php echo $action; ?></a>
                                                         
                                                         <?php } ?>

                                                         <?php if(($_SESSION['PROFIL']==3 || $_SESSION['PROFIL']==5) && $one['onglet']>"2" && $one['onglet']!="9"){ ?> 
                                                         <a href="#" class="label label-success " data-toggle="modal" data-target="#<?php echo $one['id_Tc']; ?>mod1" style="background:#a1c1e7 ; color:#000;">Modif.Courrier</a>
                                                         
                                                         <?php } ?>
                                                         <?php if( ($_SESSION['PROFIL']==4 || $_SESSION['PROFIL']==5) && $one['onglet']=="3"){ ?> 
                                                         <a href="#" class="label label-success " data-toggle="modal" data-target="#<?php echo $one['id_Tc']; ?>mod" style="background:#a1c1e7 ; color:#000;"><?php echo $action; ?></a>
                                                         
                                                         <?php } ?>

                                                         <?php if(($_SESSION['PROFIL']==4 || $_SESSION['PROFIL']==5) && $one['onglet']=="4"){ ?> 
                                                         <a href="#" class="label label-success " data-toggle="modal" data-target="#<?php echo $one['id_Tc']; ?>mod1" style="background:#a1c1e7 ; color:#000;">Modif.Contestation</a>
                                                         <?php } ?>

                                                         

                                                         <?php if( ($_SESSION['PROFIL']==1 || $_SESSION['PROFIL']==5) && $one['onglet']=="9"){ ?> 
                                                         <!-- <a href="#" class="label label-success " data-toggle="modal" data-target="#<?php echo $one['id_Tc']; ?>mod" style="background:#a1c1e7 ; color:#000;"><?php echo $action; ?></a> -->
                                                         <?php } ?>

                                                         <?php if( ($_SESSION['PROFIL']=='6' && ($one['onglet']=="2" || $one['onglet']=="4") ) ){ ?> 
                                                         <a href="#" class="label label-success " data-toggle="modal" data-target="#<?php echo $one['id_Tc']; ?>mod" style="background:#a1c1e7 ; color:#000;"><?php echo $action; ?></a>
                                                         <a href="#" class="label label-success " data-toggle="modal" data-target="#<?php echo $one['id_Tc']; ?>mod" style="background:#a1c1e7 ; color:#000;"><?php echo $Leretour; ?></a>
                                                         <?php } 
                                                          elseif( $one['onglet']=="4"){ ?> 
                                                         <a href="#" class="label label-success " data-toggle="modal" data-target="#<?php echo $one['id_Tc']; ?>mod#" style="background:#a1c1e7 ; color:#000;"><?php echo $action; ?></a>
                                                         <?php } ?>

                                                         <?php if(($_SESSION['PROFIL']==1 || $_SESSION['PROFIL']==5) && $one['onglet']=="9" && verifsoumis($one['num_tc'])==0 && veriftransmission($one['num_tc'])==0 ){ ?> 
                                                         <a href="#" class="label label-success " data-toggle="modal" data-target="#<?php echo $one['id_Tc']; ?>mod1" style="background:#a1c1e7 ; color:#000;">Modif.RDV</a>
                                                         <?php } ?>

                                                         <?php if(($_SESSION['PROFIL']==6 || $_SESSION['PROFIL']==5) && $one['onglet']=="5"){ ?> 
                                                         <a href="#" class="label label-success " data-toggle="modal" data-target="#<?php echo $one['id_Tc']; ?>mod1" style="background:#a1c1e7 ; color:#000;">Modif.RPL</a>
                                                         <?php } ?>

                                                        <?php if($one['onglet']=="9" && verif_exist_transmission($one['num_tc'])>="1" && veriftransmission($one['num_tc'])<=0 ) { ?>
                                                         ...
                                                         <?php if( $one['onglet']=="1" && ($_SESSION['PROFIL_USER']==5 || $_SESSION['PROFIL']==2) ) { ?>
                                                         ...
                                                         <?php if( $one['onglet']=="2" && $one['conformite']=="Conforme" && ( $_SESSION['PROFIL_USER']==10 || $_SESSION['PROFIL_USER']==5) ) { ?>
                                                            <a href="#" class="label label-success " title="Fiche inspection" data-toggle="modal" data-target="#<?php echo $one['id_Tc']; ?>fiche" style="background:green;  border-radius:5px;"><i class="fa fa-list" ></i></a>
                                                         <?php } ?>
