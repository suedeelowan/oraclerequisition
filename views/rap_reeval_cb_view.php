...
<body>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <form id="validationform11" method="post" >
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header sidebar-dark" style="text-align: center; color:blue;">AUDIT DE LA FICHE DE DESCRIPTION PRODUITS APRES VISITE</h5>
                                    <div class="card-body">
                                            ...
                                            <table id="table1"  class="table table-striped table-bordered second paginated1"  style="width:100%; line-height: 1;" data-show-columns="true"   data-cookie-id-table="saveId"  cellspacing="0" data-toggle="table" data-pagination="true" data-search="true" data-show-pagination-switch="false" data-show-refresh="false" data-key-events="true" data-show-toggle="true" data-resizable="false" data-cookie="true"    data-show-export="true" data-click-to-select="false" data-toolbar="#toolbar">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr style="background-color:#fff; font-size:10px;">
                                                        ...
                                                        <td style="background-color: #e2eae5;"><input type="text" name="quantite<?php echo $tcinfo['ID_ART'];?>" value="<?php echo $tcinfo['ADD_QUANTITE'] ; ?>" style="width: 35px;" id="qte<?php echo $i;?>" /> </td>
                                                        ...
                                                        <td style="background-color: #a9c2b2;"><input type="text" name="fobunit<?php echo $tcinfo['ID_ART'];?>" value="<?php echo $tcinfo['ADD_FOB_UNI'] ; ?>" oninput="calculer('qte<?php echo $i;?>','fob<?php echo $i;?>','resultat<?php echo $i;?>')"  style="width: 50px;" id="fob<?php echo $i;?>" /></td>
                                            ...
                                            <table id="table2" class="table table-striped table-bordered second paginated" style="width:100%; line-height: 1;" data-show-columns="true"   data-cookie-id-table="saveId"  cellspacing="0" data-toggle="table" data-pagination="true" data-search="true" data-show-pagination-switch="false" data-show-refresh="false" data-key-events="true" data-show-toggle="true" data-resizable="false" data-cookie="true"    data-show-export="true" data-click-to-select="false" data-toolbar="#toolbar">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr style="background-color:#fff; font-size:10px;">
                                                        ...
                                                        <td style="background-color: #e2eae5;"><input type="text" name="unite<?php echo $tcinfo['ID_ART'];?>" value="<?php echo $tcinfo['ADD_UNITE'] ; ?>" style="width: 35px;;"/></td>
                                                        <td style="background-color: #a9c2b2;"><input type="text" name="fobunit<?php echo $tcinfo['ID_ART'];?>" value="<?php echo $tcinfo['ADD_FOB_UNI'] ; ?>" style="width: 50px;"  /></td>
                                                        <td style="background-color: #a9c2b2;"><input type="text" name="fobtotal<?php echo $tcinfo['ID_ART'];?>" value="<?php echo $tcinfo['ADD_FOB_TOTAL'] ; ?>" style="width: 85px;"   /></td>
                                                        <td style="background-color: #a9c2b2;"><input type="text" name="dc<?php echo $tcinfo['ID_ART'];?>" value="<?php echo $tcinfo['DC_PREVISIONNEL'] ; ?>" style="width: 80px;;" /></td>
                                ...
                                <div class="@@">
                                    ...
                                    <!-- <form id="validationform" method="post" data-parsley-validate="" novalidate=""> -->
                                        <div class="card">
                                                ...
                                                <div class="row">
                                                        <div class="col-4">
                                                            <div class="form-group row">
                                                                        ...
                                                                        <input type="hidden"  class="form-control" name="id_Tc" value='<?php echo $one['id_Tc']; ?>'>
                                                                            <input type="date"  class="form-control" name="date_envoi_reev" value="<?php echo $tc_trouve['date_envoi_reev'];?>"  style="height: 30px;font-size:14px;" >
                                                        ...
                                                        <div class="col-4">
                                                                <div class="form-group row">
                                                                        ...
                                                                        <div class="col-12 col-sm-8 col-lg-6" >
                                                                            <input type="date"  class="form-control" name="date_reev"  value="<?php echo date('Y-m-d',time());?>" readonly style="height: 30px;font-size:14px;" >
                                                                        </div>
                                                                </div>
                                                        ...
                                                        <div class="col-4">
                                                                <div class="form-group row">
                                                                        ...
                                                                        <div class="col-12 col-sm-8 col-lg-6" >
                                                                            <input type="date"  class="form-control" name="datevalid" value="<?php echo date('Y-m-d',time());?>" readonly style="height: 30px;font-size:14px;" >
                                                                        </div>
                                                                </div>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-4">
                                                                <div class="form-group row">
                                                                        ...
                                                                        <div class="col-12 col-sm-8 col-lg-6" >
                                                                            <input type="text" id="result"  class="form-control" name="fob_reeva" value="<?php echo $leFobTotal ;?>" style="height: 30px;font-size:14px;" >
                                                                        </div>
                                                                </div>
                                                        ...
                                                        <div class="col-4">
                                                                <div class="form-group row">
                                                                        ...
                                                                        <div class="col-12 col-sm-8 col-lg-6" >
                                                                            <input type="text"  class="form-control" name="dc_prevision" id="resultledc" value="<?php echo $leDcTotal ;?>" style="height: 30px;font-size:14px;" >
                                                                        </div>
                                                                </div>
                                                        ...
                                                        <div class="col-4">
                                                            ...
                                                            <div class="form-group row">
                                                                        ...
                                                                        <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="date"  class="form-control" name="date_envoi_pl_reev" value="<?php echo date('Y-m-d',time());?>" required style="height: 30px;font-size:14px;" >
                                                                ...
                                                                <div class="form-group row">
                                                                        ...
                                                                        <div class="col-8" >
                                                                            <select  name="agent_reeva" class="form-control" required style="height: 30px;font-size:14px;"  >
                                                                                    <option value="<?php echo $tc_trouve['agent_reeva'];?>"><?php echo $tc_trouve['agent_reeva'];?></option>
                                                                ...
                                                                <div class="form-group row">
                                                                        ...
                                                                        <div class="col-8" >
                                                                            <select  name="agent_audit" class="form-control" required style="height: 30px;font-size:14px;"  >
                                                                                    <option value="<?php echo $tc_trouve['agent_audit'];?>"><?php echo $tc_trouve['agent_audit'];?></option>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-4">
                                                            ...
                                                            <div class="form-group row">
                                                                        ...
                                                                        <input type="date"  class="form-control" name="date_valid_reeva" value="<?php echo date('Y-m-d',time());?>" required style="height: 30px;font-size:14px;" >
                                                        ...
                                                        <div class="col-8">
                                                                <div class="form-group row">
                                                                        ...
                                                                        <div class="col-10 col-sm-8 col-lg-6" >
                                                                            <textarea   class="form-control" rows="2" cols="40" name="observation_reeva" required="required"  style="height: 30px;font-size:14px;" ></textarea>
                                                                        </div>
                                                                </div>
                                            ...
                                            <!-- <div class="row"> -->
                                                <?php if($tc_trouve['onglet']==1){ ?>
                                                <div class="col-12">
                                                    <div class="form-group row text-right">
                                                        <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0"><br/><br/>
                                                            <button type="submit" class="btn btn-space btn-success"  style="width:120px; height: 35px;  border-radius: 6px; background-color:#b8ecb8 ; color:#000;"   name="envoyer_reev">Enregistrer</button>
                                                            <button class="btn btn-space btn-secondary" data-dismiss="modal">Annuler</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php } else{  echo '<br/><br/><br/><br/><a href="liste_tc" class="btn btn-space btn-primary">Retour a la liste </a>';} ?>
                                            <!-- </div>    -->
                                        </div>
    ...
    <script>
        // Initialiser Select2 sur le champ select
    ...
    <script>
            function calculer(qte,fob,resultattotal) {
               ...
               // alert(document.getElementById(qte).value);
