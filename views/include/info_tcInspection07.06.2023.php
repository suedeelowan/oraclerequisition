                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-12 col-sm-8 col-lg-6">
                                                                    ...
                                                                    <input type="text"  class="form-control" required name="num_tc" disabled id="myInput" value='<?php echo $one['num_tc']; ?>'style=" background-color:#e3f0fe ; ">
                                                        ...
                                                        <div class="col-4">  
                                                            <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6" >
                                                                        <input type="date"  class="form-control" required name="date_tc" disabled  value='<?php echo $one['date_tc']; ?>'style="  background-color:#e3f0fe ; ">
                                                                    </div>
                                                            </div> 
                                                        ...
                                                        <div class="col-4">
                                                            <div class="form-group row">
                                                                        ...
                                                                        <div class="col-12 col-sm-8 col-lg-6">
                                                                            <input type="date"  class="form-control" name="date_requi" disabled  required value='<?php echo $one['SDGR_Date']; ?>' style=" background-color:#e3f0fe ; ">
                                                                        </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-4">
                                                                    ...
                                                                    <div class="form-group row">
                                                                            <label class="col-12 col-sm-6 col-form-label text-sm-left"><FONT size="2"color="#000000">Moyen de transport</FONT></label>
                                                                                <div class="col-12 col-sm-8 col-lg-6">
                                                                                    <select  name="moyen_transport" disabled class="form-control" style=" background-color:#e3f0fe ;">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                                    ...
                                                                    <div class="form-group row">
                                                                            ...
                                                                            <div class="col-10" >
                                                                                <textarea id="story" rows="" cols="100" class="form-control colorconsul" name="marchandise"   style="background-color:#e3f0fe ;"><?php echo $one['marchandise']; ?></textarea>
                                                                            </div>
                                                                    </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="date"  class="form-control" name="date_visite" disabled  value='<?php echo $one['date_visite']; ?>' required style="  background-color:#e3f0fe ; ">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-8">
                                                            <div class="form-group row">
                                                                    ...
                                                                    <div class="col-9">
                                                                        <input type="text"  class="form-control" name="lieu_visite" disabled  value='<?php echo $one['lieu_visite']; ?>' required style="  background-color:#e3f0fe ; ">
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="date"  name="Date_cotation" disabled value='<?php echo $one['date_cotation']; ?>'required class="form-control"style="  background-color:#e3f0fe ; ">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-8">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-9">
                                                                        <select  name="agent_visiteur" disabled class="form-control" required style=" background-color:#e3f0fe ; ">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                    <select  name="type_visite" disabled class="form-control" required style=" background-color:#e3f0fe ; ">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <select  name="conformite" disabled class="form-control" required style="background-color:#e3f0fe ; " >
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <select  name="vav" disabled class="form-control" style=" background-color:#e3f0fe ; " >
                                                        ...
                                                        <div class="col-8">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-9">
                                                                        <select  name="nom_op_visite" disabled class="form-control" style=" background-color:#e3f0fe ; ">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-10 ">
                                                                        <select  name="nom_off_visiteur" class="form-control" required style=" background-color:#e3f0fe ; "  disabled >
                                                            ...
                                                            <div class="form-group row ">
                                                                ...
                                                                <div class="col-10" >
                                                                    <div class="row" id="t_rapporti++"style="white-space: no-wrap;">
                                                                                <select id="mySelect21" multiple="multiple" style="width: 100%;" name="infraction[]" disabled>
                                                                                        <?php
                                                                                        $i=0;
