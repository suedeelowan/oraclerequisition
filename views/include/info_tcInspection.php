                                   ...
                                   <form id="validationform" method="post" data-parsley-validate="" novalidate="">
                                           <div class="card" style="height: 35px;">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-12 col-sm-8 col-lg-6">
                                                                    ...
                                                                    <input type="text"  class="form-control" required name="num_tc" disabled id="myInput" value='<?php echo $one['num_tc']; ?>'style="height: 40px;  background-color:#e3f0fe ; ">
                                                        ...
                                                        <div class="col-4">  
                                                            <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6" >
                                                                        <input type="date"  class="form-control" required name="date_tc" disabled  value='<?php echo $one['date_tc']; ?>'style="height: 40px;  background-color:#e3f0fe ; ">
                                                                    </div>
                                                            </div> 
                                                        ...
                                                        <div class="col-4">
                                                            <div class="form-group row">
                                                                        ...
                                                                        <div class="col-12 col-sm-8 col-lg-6">
                                                                            <input type="date"  class="form-control" name="date_requi" disabled  required value='<?php echo $one['SDGR_Date']; ?>' style="height: 40px;  background-color:#e3f0fe ; ">
                                                                        </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-12 col-sm-8 col-lg-6">
                                                                     <input type="text"  class="form-control" required name="code_imp" disabled  value='<?php echo $one['code_imp']; ?>'style="height: 40px;  background-color:#e3f0fe ; ">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-8">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-9 ">
                                                                    <input type="text"  class="form-control" required name="nom_imp" disabled  value='<?php echo $one['nom_imp']; ?>'style="height: 40px;  background-color:#e3f0fe ; ">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-4">
                                                                ...
                                                                <div class="form-group row">
                                                                        ...
                                                                        <div class="col-12 col-sm-8 col-lg-6">
                                                                            <input type="text"  class="form-control" required name="code_declara" disabled value='<?php echo $one['code_declara']; ?>'style="height: 40px;  background-color:#e3f0fe ; ">
                                                                        </div>
                                                                </div>
                                                        ...
                                                        <div class="col-8">        
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-9">
                                                                        <input type="text"  class="form-control" required name="nom_declara" disabled value='<?php echo $one['nom_declara']; ?>'style="height: 40px;  background-color:#e3f0fe ; ">
                                                                    </div>
                                                                </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-4">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-12 col-sm-8 col-lg-6 picto-item" aria-label="<?php echo $one['num_declaration']; ?>">
                                                                    ...
                                                                    <input type="text"  class="form-control" name="num_declara" disabled value='<?php echo $one['num_declaration']; ?>'style="height: 40px;  background-color:#e3f0fe ; ">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-4">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="date"  class="form-control" required name="date_delara" disabled value='<?php echo $one['date_declara']; ?>'style="height: 40px; background-color:#e3f0fe ;">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-4">
                                                                    ...
                                                                    <div class="form-group row">
                                                                            <label class="col-12 col-sm-6 col-form-label text-sm-left"><FONT size="2"color="#000000">Moyen de transport</FONT></label>
                                                                                <div class="col-12 col-sm-8 col-lg-6">
                                                                                    <select  name="moyen_transport" disabled class="form-control" style="height: 40px; background-color:#e3f0fe ;">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                                    ...
                                                                    <div class="form-group row">
                                                                            ...
                                                                            <div class="col-10" >
                                                                                <textarea id="story" rows="" cols="100" class="form-control colorconsul" name="marchandise"   style="height: 40px; background-color:#e3f0fe ;"><?php echo $one['marchandise']; ?></textarea>
                                                                            </div>
                                                                    </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="date"  class="form-control" name="date_visite" disabled  value='<?php echo $one['date_visite']; ?>' required style="height: 40px;  background-color:#e3f0fe ; ">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-8">
                                                            <div class="form-group row">
                                                                    ...
                                                                    <div class="col-9">
                                                                        <input type="text"  class="form-control" name="lieu_visite" disabled  value='<?php echo $one['lieu_visite']; ?>' required style="height: 40px;  background-color:#e3f0fe ; ">
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="date"  name="Date_cotation" disabled value='<?php echo $one['date_cotation']; ?>'required class="form-control"style="height: 40px;  background-color:#e3f0fe ; ">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-8">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-9">
                                                                        <select  name="agent_visiteur" disabled class="form-control" required style="height: 40px;  background-color:#e3f0fe ; ">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                    <select  name="type_visite" disabled class="form-control" required style="height: 40px;  background-color:#e3f0fe ; ">
                                                        ...
                                                        <div class="col-4">
                                                            <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="date"  name="date_Dvisite" disabled  value='<?php echo $one['date_Dvisite']; ?>'required class="form-control"style="height: 40px;  background-color:#e3f0fe ; ">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="date"  disabled class="form-control" value='<?php echo $one['date_Fvisite']; ?>' name="date_Fvisite"  required style="height: 40px;  background-color:#e3f0fe ; ">
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="date"  class="form-control" value='<?php echo $one['date_depot_visit']; ?>' required disabled name="date_rapport" style="height: 40px;  background-color:#e3f0fe ; ">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <select  name="conformite" disabled class="form-control" required style="height: 40px;  background-color:#e3f0fe ; " >
                                                        ...
                                                        <div class="col-4" <?php if($one['conformite']=='conforme') echo ' style="display: none;"'; ?>>
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6" >
                                                                        <input type="date"  class="form-control" required disabled name="dateEnvReev" value='<?php echo $one['date_envoi_reev']; ?>'style="height: 40px;  background-color:#e3f0fe ; ">
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="row" <?php if($one['conformite']=='conforme') echo ' style="display: none;"'; ?>>
                                                        <div class="col-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <select  name="vav" disabled class="form-control" style="height: 40px;  background-color:#e3f0fe ; " >
                                                        ...
                                                        <div class="col-8" <?php if($one['vav']=='non') echo ' style="display: none;"'; ?>>
                                                                <div class="form-group row">
                                                                    <label class="col-3 col-form-label text-sm-left"><FONT size="2"color="#000000">Nom Operateur visite</FONT></label>
                                                                    <div class="col-9">
                                                                        <select  name="nom_op_visite" disabled class="form-control" style="height: 40px;  background-color:#e3f0fe ; ">
                                                    ...
                                                    <div class="row" <?php if($one['conformite']=='conforme'  OR $one['vav']=='non' ) echo ' style="display: none;"'; ?>>    
                                                         <div class="col-12">
                                                                <div class="form-group row">
                                                                    <label class="col-2 col-form-label text-sm-left"><FONT size="2"color="#000000">Nom Officier visite</FONT></label>
                                                                    <div class="col-10">
                                                                        <select  name="nom_off_visiteur"  class="form-control" required style="height: 40px;  background-color:#e3f0fe ; "  disabled >
                                                    ...
                                                    <div class="row" >
                                                        <div class="col-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-10 ">
                                                                    <textarea id="story" rows="" cols="100" class="form-control colorconsul" name="marchandise_add"   style="height: 40px; background-color:#e3f0fe ;"><?php echo $one['marchandise_add']; ?></textarea>
                                                            ...
                                                            <div class="form-group row ">
                                                                ...
                                                                <div class="col-10" >
                                                                    <div class="row" id="t_rapporti++"style="white-space: no-wrap;">
                                                                                <select id="mySelect22" multiple="multiple" style="width: 100%; background-color:#e3f0fe ;" name="infraction[]" disabled >
                                                                                        <?php
                                                                                        $i=0;
