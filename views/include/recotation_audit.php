                                                ...
                                                <div class="col-4">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-12 col-sm-8 col-lg-6" >
                                                                <input type="date"  class="form-control" required name="dateanc" value='<?php echo $one['date_validation']; ?>' readonly>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-12 col-sm-10 col-lg-8">
                                                                ...
                                                                <option value="" >Selectionner l'agent ...</option>
                                                                           <?php foreach(agt_service(AUDI) as $index => $nomreeval) : ?>
                                                                           <option value="<?php echo $nomreeval['MATRICULE'].''.$nomreeval['NOM_AG']; ?>" <?php if($one['agent_audit']==$nomreeval['NOM_AG']) echo 'selected="selected"';?>><?php echo $nomreeval['NOM_AG']; ?></option>
                                                                           <?php endforeach; ?>
                                                                </select>
                                                        </div>
                                                    </div>
