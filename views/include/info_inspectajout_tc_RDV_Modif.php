                                ...
                                <div class="card-body">
                                   <form id="validationform" method="post" data-parsley-validate="" novalidate="">
                                           <div class="card" style="height: 35px;">
                                            ...
                                            <div class="card" style="height: 35px;">
                                            <h5 class="card-header"><span style="color:green; font-size:15px;">Prise de rendez-vous</span></h5>
                                            </div>
                                            <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-4">
                                                        ...
                                                        <div class="col-8">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-10 ">
                                                                        <textarea name="lieu_visite"  class="form-control" style="height:50px;font-size:14px; width: 100%;"> <?php echo $one['lieu_visite']; ?> </textarea>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-10 ">
                                                                        <select  name="agent_visiteur" class="form-control" required="required" >
                                                                            <option value="<?php echo $one['agent_visiteur']; ?>"><?php echo $one['agent_visit']; ?></option>
                                                    ...
                                                    <div class="row" id="cacherVAV1">
                                                        ...
                                                        <div class="col-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-10 ">
                                                                    <input class="form-control" required="required" style="height: 30px;font-size:14px; width: 100%;" name="nom_agent_PL" value="<?php echo $one['nom_agent_PL']; ?>" />
                                                    ...
                                                    <div class="row" >
                                                        ...
                                                        <div class="col-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-10 ">
                                                                        <textarea class="form-control" required="required" style="height: 50px;font-size:14px; width: 100%;" name="instru_chef"><?php echo utf8_encode($one['INSTRUCTION_CHEF']); ?> </textarea>
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group row text-right">
                                                                            <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                                                                <button type="submit" class="btn btn-space btn-primary" style="width:120px; height: 35px;" name="ModifierRDV">Modifier</button>
