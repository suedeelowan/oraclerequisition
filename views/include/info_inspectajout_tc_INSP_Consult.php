                    ...
                    <div class="row">
                        ...
                        <!-- valifation types -->
                         ...
                         <?php if($_GET['search']){ echo $tc_trouve['date_tc']; }?>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="width:1000px; margin-left:-20px; height:1030px;margin-top:-20px;">
                                                                ...
                                                                <div class="form-group row ">
                                                                    ...
                                                                    <div class="col-10" >
                                                                        <div class="row" id="t_rapporti++"style="white-space: no-wrap;height: 30px;font-size:14px;">
                                                                                    <select id="mySelect24" multiple="multiple" style="width: 100%; background-color:#e3f0fe ;height: 30px;font-size:14px;" name="infraction[]" disabled>
                                                                                            <?php
                                                                                            $i=0;
