                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group row">
                                        ...
                                        <input type="text"  class="form-control" required name="num_tc" id="myInput" value='<?php echo $one['num_tc']; ?>'style="height: 40px;">
                                ...
                                <div class="col-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6" >
                                                <input type="date"  class="form-control" required name="date_tc" value='<?php echo $one['date_tc']; ?>'style="height: 40px;">
                                            </div>
                                        </div>  
                                ...
                                <div class="col-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                             <input type="text"  class="form-control" required name="code_imp" value='<?php echo $one['code_imp']; ?>'style="height: 40px;">
                                        </div>
                                    </div>
                                ...
                                <div class="col-8">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <input type="text"  class="form-control picto-item" required name="nom_declara" value='<?php echo $one['nom_declara']; ?>'style="height: 40px;">
                                            </div>
                                        </div> 
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                        <input type="date"  class="form-control" name="date_visite"  value='<?php echo $one['date_visite']; ?>' required style="height: 40px;">
                                        </div>
                                    </div>
                                ...
                                <div class="col-8">
                                    <div class="form-group row">
                                            ...
                                            <div class="col-9 ">
                                                <input type="text"  class="form-control" name="lieu_visite" value='<?php echo $one['lieu_visite']; ?>' required style="height: 40px;">
                                            </div>
                                    </div>
                                ...
                                <div class="col-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="date"  name="Date_cotation" value='<?php echo $one['date_cotation']; ?>'required class="form-control"style="height: 40px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-sm-8 col-lg-6">
                                                <select  name="agent_visiteur" class="form-control" required >
                                                    ...
                                                    <option value="<?php echo $agtinspec['MATRICULE_AG'].'-'.$agtinspec['NOM_AG']; ?>" <?php if($one['agent_visit']==$agtinspec['MATRICULE_AG'].'-'.$agtinspec['NOM_AG']) echo "selected='selected'"; ?>><?php echo $agtinspec['MATRICULE_AG'].'-'.$agtinspec['NOM_AG']; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="col-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <select  name="type_visite" class="form-control" required style="height: 40px;">
                                ...
                                <div class="col-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="date"  name="date_Dvisite" value='<?php echo $one['date_Dvisite']; ?>'required class="form-control"style="height: 40px;">
                                            </div>
                                        </div>
                                </div>
                                <div class="col-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="date"  class="form-control" value='<?php echo $one['date_Fvisite']; ?>' name="date_Fvisite"  required style="height: 40px;">
                                            </div>
                                        </div>
                                ...
                                <div class="col-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="date"  class="form-control" value='<?php echo $one['date_depot_visit']; ?>' required name="date_rapport" style="height: 40px;">
                                            </div>
                                        </div>
                                ...
                                <div class="col-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <select  name="conformite" class="form-control" required  id="resultvisit" onchange="afficherBloc()">
                            ...
                            <div class="row col-12"  >
                                <div class="col-4" id="blocConformite1">
                                        <div class="form-group row" >
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <select  name="vav" class="form-control"  id="resultvav" onchange="cacherBloc()">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12" id="modifnonc">
                                                <div class="form-group row ">
                                                    ...
                                                    <div class="col-10" >
                                                        <select id="mySelect1insptc_modif" multiple="multiple" style="width: 100%;" name="infraction[]">
                                                                <?php
                                                                $i=0;
