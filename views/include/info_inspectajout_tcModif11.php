                                                    ...
                                                    <div class="row">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-9">
                                                                        <select  name="nom_op_visite" class="form-control" style="height: 30px;">
                                                                            <option value="">Seelectionner ...</option>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-10 col-sm-8 col-lg-6">
                                                                        <select  name="nom_off_visiteur" class="form-control" required  >
                                                                            <option value="">Selectionner ... 1<?php echo $one['nom_off_visiteur']; ?></option>
                                                        ...
                                                        <div class="col-12">
                                                                        <div class="form-group row ">
                                                                            ...
                                                                            <div class="col-10" >
                                                                                <select id="mySelect1inspxc" multiple="multiple" style="width: 100%;" name="infraction[]">
                                                                                        <?php
                                                                                        $i=0;
                                                                                ...
                                                                                <!-- <div class="row" id="t_rapporti++"style="white-space: no-wrap;" >
                                                                                    ...
                                                                                    &nbsp;&nbsp;<input type="checkbox" id="checkbox"  <?php if($minv=='1'){ echo 'checked="checked"';} ?> name="infraction[]"  value="Minoration de la valeur Fob">&nbsp; Minoration de la valeur Fob &nbsp;
                                                                                    &nbsp;&nbsp;<input type="checkbox" id="checkbox"  <?php if($minq=='1'){ echo 'checked="checked"';} ?> name="infraction[]"  value="Minoration de quantite">&nbsp; Minoration de quantité &nbsp;
                                                                                    &nbsp;&nbsp;<input type="checkbox" id="checkbox"  <?php if($glit=='1'){ echo 'checked="checked"';} ?> name="infraction[]"  value="Glissement tarifaire">&nbsp; Glissement tarifaire &nbsp;
                                                                                    &nbsp;&nbsp;<input type="checkbox" id="checkbox"  <?php if($fd=='1'){ echo 'checked="checked"';} ?> name="infraction[]"  value="Minoration de la valeur Fret">&nbsp; Minoration de la valeur Fret &nbsp;
