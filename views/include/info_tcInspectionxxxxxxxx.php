                    ...
                    <div class="row">
                        ...
                        <?php if($_GET['search']){ echo $tc_trouve['date_tc']; }?>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="width:1050px; margin-left:-20px; height:15px;margin-top:-20px;">
                                ...
                                <div class="card-body">
                                   <form id="validationform" method="post" data-parsley-validate="" novalidate="">
                                           <div class="card">
                                            ...
                                            <div class="card-body" style="width:1050px; margin-left:-20px; height:15px;margin-top:-20px;">
                                                    <div class="row">
                                                        <div class="col-4">
