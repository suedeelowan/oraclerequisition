                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-8">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-10 ">
                                                                        <input type="text" required="required" class="form-control" name="lieu_visite"  style="height: 40px;">
                                                                    </div>
                                                                </div>
                                                        </div>
                                                        <div class="col-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="date"  required="required" name="Date_cotation"  class="form-control"style="height: 40px;">
                                                                    </div>
                                                                </div>
                                                        </div>
                                                        <div class="col-8">
                                                    ...
                                                    <div class="row" id="cacherVAV1">
                                                        ...
                                                        <div class="col-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-10 ">
                                                                        <select  name="nom_off_visiteur" class="form-control" required="required" >
                                                                            <option value="">Selectionner ...</option>
                                                    ...
                                                    <div class="row" >
                                                        <div class="col-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-10 ">
                                                                        <input type="text"  required="required" name="marchandise_add" value="" class="form-control"/> 
                                                                    </div>
                                                                </div>
