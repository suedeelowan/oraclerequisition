                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-10 ">
                                                                        <select  name="nom_agent_PL" class="form-control" required="required" >
                                                                            <option value="<?php echo $one['nom_agent_PL']; ?>"><?php echo $one['nom_agent_PL']; ?></option>
                                                                            <?php foreach(agt_service(OFFVISIT) as $index => $nominspection) : ?>
                                                                            <option value="<?php echo  $agtinspec['MATRICULE_AG'].'-'.$nominspection['NOM_AG']; ?>"><?php echo $nominspection['NOM_AG']; ?></option>
                                                                            <?php endforeach; ?>
                                                    ...
                                                    <div class="row" >
                                                        ...
                                                        <div class="col-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-10 ">
                                                                        <textarea class="form-control" required="required" style="height: 50px;font-size:14px; width: 100%;" name="instru_chef" readonly ><?php echo $one['INSTRUCTION_CHEF']; ?> </textarea>
