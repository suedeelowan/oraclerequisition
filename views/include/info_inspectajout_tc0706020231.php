                                   ...
                                   <form id="validationform" method="post" data-parsley-validate="" novalidate="">
                                           <div class="card">
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <div class="row col-12" id="blocConformite1">
                                                        <div class="col-4">
                                                                <div class="form-group row">
                                                    ...
                                                    <div class="row" id="doubleconfort" style="display: none;">
    ...
    <script>
         function afficherBloc() {
            ...
            var doubleconfort = document.getElementById("doubleconfort");
            ...
            if (selectedValue === "conforme")
             {
                ...
                doubleconfort.style.display = "block";
