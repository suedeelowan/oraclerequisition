                                   ...
                                   <form id="validationform" method="post" data-parsley-validate="" novalidate="">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-12 col-sm-8 col-lg-6">
                                                                    <input type="text"  class="form-control" required name="code_declara" value='<?php echo $one['code_imp']; ?>'style="height: 30px;">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-12 col-sm-8 col-lg-6">
                                                                    ...
                                                                    <input type="text"  class="form-control" name="num_declara" value='<?php echo $one['num_declara']; ?>'style="height: 30px;">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-4">   
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6" >
                                                                        <input type="date"  class="form-control" required name="dateEnvReev" value='<?php echo $one['dateEnvReev']; ?>'style="height: 30px;">
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="date"  class="form-control" required name="date_rapport" style="height: 30px;">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="date"  class="form-control" name="date_Fvisite"  required style="height: 30px;">
                                                                    </div>
                                                                </div>
                                                         ...
                                                         <div class="col-4">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="date"  class="form-control" name="date_visite"  required style="height: 30px;">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-12 col-sm-6 col-form-label text-sm-left"><FONT size="2"color="#000000">Lieu de visite</FONT></label>
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="text"  class="form-control" name="lieu_visite" required style="height: 30px;">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                      ...
                                      <!-- <form id="validationform" data-parsley-validate="" novalidate=""> -->
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="date"  name="Date_cotation" required class="form-control"style="height: 30px;">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-12 col-sm-6 col-form-label text-sm-left"><FONT size="2"color="#000000">Date debut visite</FONT></label>
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="date"  name="date_Dvisite" required class="form-control"style="height: 30px;">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                    ...
                                                    <div class="row">
                                                            <div class="col-4">
                                                                    <div class="form-group row ">
                                                                            ...
                                                                            <div class="col-12 col-sm-8 col-lg-6" >
                                                                                <textarea id="story" rows="" cols="100" class="form-control" name="infraction" style="height: 30px;"><?php echo $one['infraction']; ?></textarea>
                                                                            </div>
                                                                    </div>
                                                            </div>
    ...
    <script>
        ...
        function recherchetc(val) {
                    ...
                    window.location.href = "liste_tc?search="+ledata+"&tcid="+datatc;
                        ...
                        //Pour le select2 provient de liste
