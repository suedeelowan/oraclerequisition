                                   ...
                                   <form id="validationform" method="post" data-parsley-validate="" novalidate="">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <div class="form-group row">
                                                                ...
                                                                <input type="text"  class="form-control" required name="num_tc" disabled id="myInput" value='<?php echo $one['num_tc']; ?>'style="height: 30px;">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-12 col-sm-8 col-lg-6">
                                                                     <input type="text"  class="form-control" required name="code_imp" disabled  value='<?php echo $one['code_imp']; ?>'style="height: 30px;">
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-12 col-sm-8 col-lg-6">
                                                                    <input type="text"  class="form-control" required name="code_declara" disabled value='<?php echo $one['code_declara']; ?>'style="height: 30px;">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-12 col-sm-8 col-lg-6">
                                                                    ...
                                                                    <input type="text"  class="form-control" name="num_declara" disabled value='<?php echo $one['num_declaration']; ?>'style="height: 30px;">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6" >
                                                                        <input type="date"  class="form-control" required name="date_tc" disabled  value='<?php echo $one['date_tc']; ?>'style="height: 30px;">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="text"  class="form-control" required name="nom_imp" disabled  value='<?php echo $one['nom_imp']; ?>'style="height: 30px;">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="text"  class="form-control" required name="nom_declara" disabled value='<?php echo $one['nom_declara']; ?>'style="height: 30px;">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="date"  class="form-control" required name="date_delara" disabled value='<?php echo $one['date_declara']; ?>'style="height: 30px;">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-4">   
                                                                    <div class="form-group row">
                                                                            <label class="col-12 col-sm-6 col-form-label text-sm-left"><FONT size="2"color="#000000">Moyen de transport</FONT></label>
                                                                                <div class="col-12 col-sm-8 col-lg-6">
                                                                                    <select  name="moyen_transport" disabled class="form-control" style="height: 30px;">
                                                                    ...
                                                                    <div class="form-group row">
                                                                            ...
                                                                            <div class="col-12 col-sm-8 col-lg-6" >
                                                                                <textarea id="story" rows="" cols="100" class="form-control" name="marchandise" disabled  style="height: 60px;"><?php echo $one['marchandise']; ?></textarea>
                                                                            </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label class="col-12 col-sm-6 col-form-label text-sm-left"><FONT size="2"color="#000000">Date de requisition</FONT></label>
                                                                        <div class="col-12 col-sm-8 col-lg-6">
                                                                            <input type="date"  class="form-control" name="date_requi" disabled  required value='<?php echo $one['SDGR_Date']; ?>' style="height: 30px;">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-12 col-sm-8 col-lg-6" >
                                                                            <input type="date"  class="form-control" required disabled name="dateEnvReev" value='<?php echo $one['date_envoi_reev']; ?>'style="height: 30px;">
                                                                        </div>
                                                                   </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="date"  class="form-control" value='<?php echo $one['date_depot_visit']; ?>' required disabled name="date_rapport" style="height: 30px;">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <select  name="conformite" disabled class="form-control" required style="height: 30px;" >
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                    <select  name="type_visite" disabled class="form-control" required style="height: 30px;">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="date"  disabled class="form-control" value='<?php echo $one['date_Fvisite']; ?>' name="date_Fvisite"  required style="height: 30px;">
                                                                    </div>
                                                                </div>
                                      ...
                                      <!-- <form id="validationform" data-parsley-validate="" novalidate=""> -->
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="date"  class="form-control" name="date_visite" disabled  value='<?php echo $one['date_visite']; ?>' required style="height: 30px;">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-12 col-sm-6 col-form-label text-sm-left"><FONT size="2"color="#000000">Lieu de visite</FONT></label>
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="text"  class="form-control" name="lieu_visite" disabled  value='<?php echo $one['lieu_visite']; ?>' required style="height: 30px;">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-12 col-sm-6 col-form-label text-sm-left"><FONT size="2"color="#000000">VAV</FONT></label>
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <select  name="vav" disabled class="form-control" style="height: 30px;" >
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <select  name="nom_op_visite" disabled class="form-control" style="height: 30px;">
                                      ...
                                      <!-- <form id="validationform" data-parsley-validate="" novalidate=""> -->
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <select  name="agent_visiteur" disabled class="form-control" required style="height: 30px;">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="date"  name="Date_cotation" disabled value='<?php echo $one['date_cotation']; ?>'required class="form-control"style="height: 30px;">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-12 col-sm-6 col-form-label text-sm-left"><FONT size="2"color="#000000">Date debut visite</FONT></label>
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <input type="date"  name="date_Dvisite" disabled  value='<?php echo $one['date_Dvisite']; ?>'required class="form-control"style="height: 30px;">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-12 col-sm-6 col-form-label text-sm-left"><FONT size="2"color="#000000">Nom Officier visite</FONT></label>
                                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                                        <select  name="nom_off_visiteur" disabled class="form-control" required style="height: 30px;" style="height: 30px;" >
                                                    ...
                                                    <!-- <div class="row">
                                                            <div class="col-4">
                                                                    <div class="form-group row ">
                                                                            <label class="col-2 col-sm-6 col-form-label text-sm-left"><FONT size="2"color="#000000">Infraction</FONT></label>
                                                                            <div class="col-10 col-sm-8 col-lg-6" >
                                                                                <?php 
                                                                                   
                                                                                   echo str_replace('|',nl2br('&thinsp;'),$one['infraction']);  
                                                                                ?>
                                                                                <textarea id="story" rows="10" cols="100" class="form-control" disabled name="infraction" style="height: 40px;">
                                                                                <?php //echo substr_count ($one['infraction'],'|');  ?>
                                                                                <?php 
                                                    ...
                                                    <div class="form-group row ">
                                                        ...
                                                        <div class="col-10" >
                                                            <div class="row" id="t_rapporti++"style="white-space: no-wrap;"><?php 
                                                                                   ...
                                                                                   $linfraction=explode('|',$one['infraction']);
                                                                                    ...
                                                                                    for ($i = 0; $i <= $nbre-1; $i++) {
                                                                                     ...
                                                                                     echo '<input type="checkbox"  checked="checked" >&nbsp; '.$linfraction[$i].'&nbsp;';
                                                                                 }
                                                                ...
                                                                <!-- &nbsp;&nbsp;<input type="checkbox" id="checkbox" name="infraction[]"  value="Minoration de valeur">&nbsp; Minoration de valeur &nbsp;
                                                                ...
                                                                &nbsp;&nbsp;<input type="checkbox" id="checkbox" name="infraction[]"  value="Fausse declaration">&nbsp; Fausse déclaration &nbsp; -->
