                                       ...
                                       <?php foreach ($all as $index => $one): ?>
                                            <tr style="line-height: 12px ;">
                                                ...
                                                <?php    
                                                         ...
                                                         if($one['onglet']==9 && verif_exist_transmission($one['num_tc'])==0){$statut="En attente de visite"; $naturedoc="Traiter le dossier";}
                                                         if($one['onglet']==9 && verif_exist_transmission($one['num_tc'])>=1){$statut="Transmis pour validation";  $naturedoc="Modifier le dossier";}
                                                         if($one['onglet']==9 && verif_retour_transmission($one['num_tc'])==1){$statut="Info Complementaire";  $naturedoc="Modifier le dossier";}
