...
b) {this.clients [a] = b}, getDOMObjectPosition: function (a) {var b = {gauche: 0, haut: 0, largeur: a.width? a.width: a.offsetWidth, hauteur: a. height? a.height: a.offsetHeight}; ""! == a.style.width && (b.width = a.style.width.replace ("px", "")); ""! == a. style.height && (b.height = a.style.height.replace ("px", "")); pour (; a;) b.left + = a.offsetLeft, b.top + = a.offsetTop, a = a .offsetParent; return b}, Client: function (a) {this.handlers = {}; this.id = h.nextId ++; this.movieId = "ZeroClipboard_TableToolsMovie _" + this.id; h.register (this.id, this ); a && this.glue (a)}};
...
""! == b && (this.div.title = b); 0! == c.width && 0! == c.height && (this.sized =! 0); this.domElement && (this.domElement.appendChild (this. div), this.div.innerHTML = this.getHTML (c.width, c.height) .replace (/ & / g, "& amp;"))}, positionElement: function () {var a = h.getDOMObjectPosition ( this.domElement), b = this.div.style; b.position = "absolu"; b.width = a.width + "px"; b.height = a.height + "px"; 0! == a.width && 0 ! == a.height && (this.sized =! 0, b = this.div.childNodes [0], b.width = a.width, b.height = a.height)}, getHTML: fonction (a, b ) {var c = "", d = "id =" + this.id +
"& width =" + a + "& height =" + b; if (navigator.userAgent.match (/ MSIE /)) {var f = emplacement.href.match (/ ^ https / i)? "https: //": "http: //"; c + = '<object classid = "clsid: D27CDB6E-AE6D-11cf-96B8-444553540000" codebase = "' + f + 'download.macromedia.com / pub / shockwave / cabs / flash / swflash. cab # version = 10,0,0,0 "width =" '+ a +' "height =" '+ b +' "id =" '+ this.movieId +' "align =" middle "> <param name =" allowScriptAccess "valeur =" toujours "/> <nom de param =" allowFullScreen "valeur =" faux "/> <nom de param =" movie "valeur =" '+ h.moviePath +' "/> <nom de param =" boucle "value = "false" /> <nom du paramètre = "menu" value = "false" /> <param name = "quality" value = "best" /> <param name = "bgcolor" value = "# ffffff" /> <param name = "flashvars" value = "'+
d + '"/> <param name =" wmode "value =" transparent "/> </ object>'} else c + = '<id imé ="' + this.movieId + '"src ="' + h.moviePath + ' "loop =" false "menu =" false "quality =" best "bgcolor =" # ffffff "width =" '+ a +' "height =" '+ b +' "name =" '+ this.movieId +' "align = "middle" allowScriptAccess = "toujours" allowFullScreen = "false" type = "application / x-shockwave-flash" pluginspage = "http://www.macromedia.com/go/getflashplayer" flashvars = "'+ d +'" wmode = "transparent" /> '; retourne c}, cache: fonction () {this.div && (this.div.style.left = "- 2000px")},
show: function () {this.reposition ()}, destroy: function () {var a = ceci; this.domElement && this.div && (g (this.div) .remove (), this.div = this.domElement = null , g.each (h.clients, fonction (b, c) {c === a && supprimer h.clients [b]}))}, repositionnement: fonction (a) {a && ((this.domElement = h. $ ( a)) || this.hide ()); if (this.domElement && this.div) {a = h.getDOMObjectPosition (this.domElement); var b = this.div.style; b.left = "" + a. left + "px"; b.top = "" + a.top + "px"}}, clearText: function () {this.clipText = ""; this.ready && this.movie.clearText ()}, appendText: function (a ) {this.clipText + =
a; this.ready && this.movie.appendText (a)}, setText: fonction (a) {this.clipText = a; this.ready && this.movie.setText (a)}, setFileName: fonction (a) {this.fileName = this.ready && this.movie.setFileName (a)}, setSheetData: fonction (a) {this.ready && this.movie.setSheetData (JSON.stringify (a))}, setAction: fonction (a) {this.action = a ; this.ready && this.movie.setAction (a)}, addEventListener: function (a, b) {a = a.toString (). toLowerCase (). replace (/ ^ on /, ""); this.handlers [a ] || (this.handlers [a] = []); this.handlers [a] .push (b)}, setHandCursor: function (a) {this.handCursorEnabled =
...
! 0; this.movie.clearText (); this.movie.appendText (this.clipText); this.movie.setFileName (this.fileName); this.movie.setAction (this.action); this.movie.setHandCursor ( this.handCursorEnabled); break; case "mouseover": this.domElement && this.cssEffects && this.recoverActive && this.domElement.addClass ("active"); break; cas "mouseout": this.domElement && this.cdomElement && this.cssEffects && (this.recoverActive =! 1, cela .domElement.hasClass ("active") && (this.domElement.removeClass ("active"), this.recoverActive =! 0)); break; cas "mousedown": this.domElement &&
...
navigator.mimeTypes ["application / x-shockwave-flash"]! == u && navigator.mimeTypes ["application / x-shockwave-flash"]. enabledPlugin) return! 0} return! 1}; n.ZeroClipboard_TableTools = h; var C = fonction (a, b) {b.attr ("id"); b.parents ("html"). Length? A.glue (b [0], ""): setTimeout (function () {C ( a, b)}, 500)}, H = fonction (a) {var b = "Sheet1"; a.sheetName && (b = a.sheetName.replace (/ [\ [\] \ * \ / \\\?? :] / g, "")); renvoyer b}, x = fonction (a, b) {b = b.match (/ [\ s \ S] {1,8192} / g) || []; a .clearText (); pour (var c = 0, d = longueur b; c <d; c ++) a.appendText (b [c])}, D = fonction (a) {retourne a.newline?
...
"xl / workbook.xml": '<? xml version = "1.0" encoding = "UTF-8" standalone = "yes"?> <classeur xmlns = "http://schemas.openxmlformats.org/spreadsheetml/2006/ main "xmlns: r =" http://schemas.openxmlformats.org/officeDocument/2006/relationships "> <fileVersion appName =" xl "lastEdited =" 5 "LowestEdited =" 5 "rupBuild =" 24816 "/> <workbookPr showInkAnnotation = "0" autoCompressPictures = "0" /> <bookViews> <classeurView xWindow = "0" yWindow = "0" windowWidth = "25600" windowHeight = "19020" tabRatio = "500" /> </ bookViews> <feuilles > <sheet name = "" sheetId = "1" r: id = "rId1" /> </ sheets> </ workbook> ',
...
F = [{match: / ^ \ -? \ D + \. \ D% $ /, style: 60, fmt: function (a) {retour a / 100}}, {match: / ^ \ -? \ D + \ .? \ d *% $ /, style: 56, fmt: fonction (a) {retour a / 100}}, {correspondance: / ^ \ -? \ $ [\ d,] +.? \ d * $ / , style: 57}, {match: / ^ \ -? £ [\ d,] +.? \ d * $ /, style: 58}, {match: / ^ \ -? € [\ d,] +. ? \ d * $ /, style: 59}, {match: / ^ \ ([\ d,] + \) $ /, style: 61, fmt: fonction (a) {return-1 * a.replace (/ [\ (\)] / g, "")}}, {correspondance: / ^ \ ([\ d,] + \. \ d {2} \) $ /, style: 62, fmt: fonction (a) {return-1 * a.replace (/ [\ (\)] / g, "")}, {match: / ^ [\ d,] + $ /, style: 63}, {match: / ^ [ \ d,] + \. \ d {2} $ /, style: 64}]; l.Buttons.swfPath = "// cdn.datatables.net/buttons/"+
