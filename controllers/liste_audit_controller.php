...
elseif($_SESSION['PROFIL']=='5' || $_SESSION['PROFIL']=='2'){
    $attribut="onglet='1' AND agent_audit IS NOT NULL";
    $all =Req_Contest::dossiervisite($attribut); 

} else{

     $attribut="onglet='1' AND SUBSTRING(agent_audit, 1, 7)='".$_SESSION['USERNAME']."'";  
    $all =Req_Contest::dossiervisite($attribut); 
}
...
if(isset($_POST['recotation'])){
    ...
    $daterevalnew            = str_secur($_POST['date_reev']);
            ...
            $all = req_contest::getrecotationaudit($num_tc,$agentnew,$daterevalnew); 
            $action="TC recoter pour auditer - agent:".$ancien_agt." a la date du ".$ancien_date;
            Histo($action,$num_tc);  
          ...
          //decrementer la charger de travail
            ...
            $commentaire="Recotation Auditeur";
