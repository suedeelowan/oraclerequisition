  ...
  // TRAITEMENT POUR LA TABLE CONTEST
   ...
   //TRAITEMENT POUR LA TABLE ARTICLE  
    ...
    foreach ($latche as $valeur) {
         ...
         $req=article:: addInspection($sh,$origine,$quantite,$unite,$valeur,$statut);
    }
    ...
    $statut=1;
    $commentaire="";
    $latransmission=transmission::transmettreinspect($numeroletc,$statut,$commentaire);
...
if(isset($_POST['recherche'])){
    ...
    $infotc=article::getUnique_tc($num_tc);
   
}
if(isset($_GET['searchok'])){
    
    $num_tc             = $_GET['searchok'];
