...
elseif($_SESSION['PROFIL_USER']=='5' || $_SESSION['PROFIL']=='2' || $_SESSION['PROFIL_USER']=='1' || $_SESSION['PROFIL']=='1'  ){
    $attribut="onglet='9' AND (INSPECTION='10' OR INSPECTION='20' OR INSPECTION='2') AND r.num_tc=t.NUM_TC ";
    $table="req_reev_contest r, transmission t";
    $all =Req_Contest::listedossier($table,$attribut); 

} else{

    //  $attribut="onglet='9'  AND SUBSTRING(agent_visit, 1, 7)='".$_SESSION['USERNAME']."' AND  R.num_tc=T.NUM_TC";  
    //  $table="req_reev_contest R, transmission T";
